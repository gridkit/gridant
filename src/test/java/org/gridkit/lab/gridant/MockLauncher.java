...
/**
 * This is a COPY of launcher for Ant.
 * Added to support test writing.
 *
 * @since Ant 1.6
 */
class MockLauncher {
     ...
     */
    public static int main(String... args) throws MalformedURLException, LaunchException {
    ...
    private int run(String[] args)
        ...
        URLClassLoader loader = new URLClassLoader(jars, MockLauncher.class.getClassLoader());
        Thread.currentThread().setContextClassLoader(loader);
        Class<?> mainClass = null;
        int exitCode = 0;
        Throwable thrown=null;
        try {
            mainClass = loader.loadClass(MainMock.class.getName());
    ...
    public static class MainMock extends Main {
