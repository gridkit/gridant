...
class Rebuilder {
     ...
     *            The deltas to apply.
     */
    public static void rebuild(OutputStream out, byte[] buf, List<Delta> deltas) throws IOException {
     ...
     *            The deltas to apply.
     */
    public static void rebuild(OutputStream out, File oldFile, List<Delta> deltas) throws IOException {
     ...
     */
    public static File rebuildFile(File oldFile, List<Delta> deltas) throws IOException {
     ...
     */
    public static void rebuildFile(File oldFile, File newFile, List<Delta> deltas) throws IOException {
     ...
     *            The {@link Delta}s to apply.
     */
    public static void rebuildFileInPlace(File file, List<Delta> deltas) throws IOException {
        ...
        for (Offsets o1 : offsets) {
            ...
            for (Iterator<Offsets> j = offsets.iterator(); j.hasNext();) {
